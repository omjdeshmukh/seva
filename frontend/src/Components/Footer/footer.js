  ...
  return(
     <div>
      <Container>
            <First>
              <h1>Seva</h1>
              <p>Consectetur adipisicing elit sed do eiusmod tempor incididunt labore etolore 
                 magna aliqua enim adena minim veniam quistane nostrud catate ullamco laboris 
          ...
          <Second>
               <SecondContainer>
                  <Image><HeadsetIcon style={{color:"yellow"}}/></Image>
                  <Column>
              ...
              <SecondContainer>
                <Image> <EmailIcon style={{color:"yellow"}}/></Image>
                <Column>
              ...
              <SecondContainer>
                 <Image><LocationOnIcon style={{color:"yellow"}}/></Image>
                 <Column>
